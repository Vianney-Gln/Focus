...
const TermOfUse = () => (
  <section className="termofuse">
    ...
    <p>
      Your privacy is important to us. It is Focus&#39; policy to respect your
      ...
      website, Focus and other sites we own and operate.{" "}
    </p>
    <p>
      This policy is effective as of 18 November 2021 and was last updated on 18
      November 2021.{" "}
    </p>
